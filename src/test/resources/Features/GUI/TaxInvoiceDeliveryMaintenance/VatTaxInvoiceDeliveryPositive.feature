@Regression @UI @VAT @VAT_TaxInvoiceDeliveryMaintenance

Feature: Verify that the VAT user can successfully create New Case in TAX Invoice Delivery Maintenance in the VAT portal,and validate their functionality.
